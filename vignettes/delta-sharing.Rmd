...
profile_url <- "https://raw.githubusercontent.com/delta-io/delta-sharing/main/examples/open-datasets.share"
...
waiting inside Delta Kernel's network I/O, that pull must return or fail before
R can handle the interrupt. Releasing a stream between pulls still releases the
Kernel reader and its temporary log immediately.
